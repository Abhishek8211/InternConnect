...
const VARIANTS = {
  primary:
    "bg-brand-500 text-white hover:bg-brand-600 shadow-glow-sm hover:shadow-glow active:scale-95",
  secondary:
    "bg-white text-slate-700 border border-slate-200 hover:border-brand-500/50 hover:bg-slate-50",
  ...
  gradient:
    "gradient-bg text-white shadow-glow-sm hover:shadow-glow active:scale-95",
};
